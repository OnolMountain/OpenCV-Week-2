...
def main():
    ...
    # write the text. Text does not move more further when the postion is at the outside of picture.
    cv.putText(face, "Face", (-10, 200), fontFace = 2, fontScale = 5, color = (0, 255, 255), thickness = 2)
